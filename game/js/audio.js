/**
 * audio.js — Web Audio API sound effects module.
 *
...
/**
 * Short filtered noise burst — gunshots, impacts, etc.
 * @param {number} dur     - Duration in seconds
 * @param {number} gain    - Master gain (0–1)
 * @param {number} decay   - Envelope steepness (higher = sharper decay)
 */
...
/**
 * Pure oscillator tone with exponential frequency + gain ramp.
